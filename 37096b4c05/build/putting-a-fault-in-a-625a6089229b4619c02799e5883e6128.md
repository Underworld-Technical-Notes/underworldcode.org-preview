...
| TI weak zone ($\eta_1$) | painted, director from the distance gradient | TI ribbon — the width is prescribed |
...
| TI band, $\eta_1 = 10^{-3}$ fixed | — | 0.5232 | 0.5000 |
